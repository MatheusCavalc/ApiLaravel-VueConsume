        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <router-link key="Products" to="/"
                :class="[true ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']"
                :aria-current="true ? 'page' : undefined">
                Products
              </router-link>
              <router-link key="New Product" to="/new-product"
              ...
              <router-link key="About" to="/about"
                :class="[false ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']"
                :aria-current="false ? 'page' : undefined">
                About
              </router-link>
